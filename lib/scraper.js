...
async function scrapeAll(cookies) {
  ...
  for (const [plannerPage, plannerHtml] of [
    ...
    try {
      ...
      console.log('Planner HTML snippet (first 600 chars):', plannerHtml.substring(0, 600));
      const plannerText = htmlToText(plannerHtml);
      console.log('Planner text snippet (first 400 chars):', plannerText.substring(0, 400));
